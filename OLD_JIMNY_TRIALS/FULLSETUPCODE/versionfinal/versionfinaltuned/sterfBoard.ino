...
void loop() {
  ...
  if (digitalRead(eButton) == LOW) {
    ...
    Debug.print("lastAxelBrakeFeedback ms ago = ");
    Debug.println(now - lastAxelBrakeFeedback);
    Debug.print("lastSteeringFeedback ms ago = ");
    Debug.println(now - lastSteeringFeedback);
    Debug.print("lastBrakeFeedback ms ago = ");
    Debug.println(now - lastBrakeFeedback);
}
