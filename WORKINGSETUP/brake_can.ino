...
const int BRAKE_SENSE_PIN = A0;
const int BRAKE_ON_THRESHOLD = 300;
...
void runHomingStateMachine() {
  ...
  switch (homingState) {
    case 0:
      ...
      homingState = 1;
      Serial.println("HOMING: Pushing forward to find brake light...");
      break;
    ...
    case 1:
      ...
      if (!isLightOn) {
        homingState = 2;
        homingTimer = millis();
        Serial.println("HOMING: Light OFF. Pausing...");
      }
      break;
    ...
    case 2:
      if (millis() - homingTimer > 200) {
        ...
        homingState = 3;
        Serial.println("HOMING: Reversing...");
      }
      break;
    ...
    case 3:
      ...
      if (isLightOn) {
        ...
        targetSteps = (long)(-maxSteps * 0.02);
        stepper.moveTo(targetSteps);
        homingState = 4;
        Serial.println("HOMING: Light ON. Adding offset...");
      }
      break;
    ...
    case 4:
      ...
      if (stepper.distanceToGo() == 0) {
        ...
        isHoming = false;
        disableMotor();
        Serial.println("INFO: Homing Complete and Zeroed.");
      }
      break;
  }
}
...
void setup() {
  ...
  isHoming = true;
  homingState = 0;
  Serial.println("INFO: Starting Homing Routine at Startup.");
